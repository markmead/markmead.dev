---
title: How to Fix Livewire Ignoring Localization Route
date: 2022/5/23
...
# How to Fix Livewire Ignoring Localization in Route
...
This is because the locale in the route is being changed.

This is caused by Livewire not using localized routes when doing its POST request to the server when a component is updated.

<Anchor title="Solving the Issue" />

We now know what the issue is and therefore, we know how to solve it.
