---
title: Jumpstart JavaScript [Part 1 - Variables]
date: 2022/2/1
description: There's a few approaches you can take to declaring variables in JavaScript, here's the differences.
tag: beginners, javascript
author: Mark Mead
---
...
# Jumpstart JavaScript [Part 1 - Variables]
...
[What is Block Scope?](#what-is-block-scope)
...
<Callout>
  Start out writing mutatable JavaScript but take a look into immutable
  JavaScript.
</Callout>
...
<Anchor title="What is Block Scope?" />
